...
function New(props) {
  return (
    <div
      className={
        'highlight__wrap-item wrap-item-highlight wrap-item-highlight_new'
      }
    >
...
function Popular(props) {
  return (
    <div
      className={
        'highlight__wrap-item wrap-item-highlight wrap-item-highlight_popular'
      }
    >
      <div className={'wrap-item-highlight__body'}>
      ...
      <div className={'item-highlight__wrap'}>
        <div className={'item-highlight__content article-highlight'}>
          <div className={'article-highlight__title'}>
            <a className={'article-highlight__link'} href={'#task2'}>
              {props.title}
            </a>
          </div>
        </div>
...
function ItemHighlight({ item }) {
  return (
    <div className={'highlight__item item-highlight'}>
      <div className={'item-highlight__body'}>{getContent(item)}</div>
    </div>
  );
}
...
function List(props) {
  return props.list.map((item) => (
    <ItemHighlightWithLabel key={nanoid()} item={item} />
  ));
}
